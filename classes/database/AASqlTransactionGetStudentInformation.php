 ...
 */
class AASqlTransactionGetStudentInformation {
    private $connection;
    private $username;
    private $assignments;
    private $error;
    ...
    public function run() {
        ...
        $sql = "SELECT DISTINCT t1.* FROM aadb.aacourse t1 "
                . "INNER JOIN aadb.aaenrolled t2 "
                . "INNER JOIN aadb.aastudents t3 "
                . "ON t2.student_ar = t3.student_ar "
                . "WHERE t3.email = '"
                . $this->username
                . "'";
        ...
        if ($this->error) {
            throw new Exception("Exception AACourse");
        }

        $sql = "SELECT DISTINCT t2.* FROM aadb.aacourse t1 "
                . "INNER JOIN aadb.aasubject t2 "
                . "INNER JOIN aadb.aaenrolled t3 "
                . "INNER JOIN aadb.aastudents t4 "
                . "ON t3.student_ar = t4.student_ar "
                . "WHERE t4.email = '"
                . $this->username
                . "'";
        ...
        if ($this->error) {
            throw new Exception("Exception AASubject");
        }

        $jsonArray['aasubject'] = $json_subject;

        
        $sql = "SELECT DISTINCT t4.* FROM aadb.aacourse t1 "
                . "INNER JOIN aadb.aasubject t2 "
                . "INNER JOIN aadb.aaenrolled t3 "
                . "INNER JOIN aadb.aastudents t4 "
                . "ON t3.student_ar = t4.student_ar "
        ...
        if ($this->error) {
            throw new Exception("Exception AAStudent");
        }

        $sql = "SELECT DISTINCT t3.* FROM aadb.aacourse t1 "
                . "INNER JOIN aadb.aasubject t2 "
                . "INNER JOIN aadb.aaenrolled t3 "
                . "INNER JOIN aadb.aastudents t4 "
                . "ON t3.student_ar = t4.student_ar "
        ...
        if ($this->error) {
            throw new Exception("Exception AAEnrolled");
        }

        $jsonArray['aaenrolled'] = $json_enrolled;

        $sql = "SELECT DISTINCT t5.* FROM aadb.aacourse t1 "
                . "INNER JOIN aadb.aasubject t2 "
                . "INNER JOIN aadb.aaenrolled t3 "
                . "INNER JOIN aadb.aastudents t4 "
                . "INNER JOIN aadb.aalogin t5 "
                . "ON t4.email = t5.username "
                . "WHERE t5.username = '"
                . $this->username
                . "'";
        ...
        if ($this->error) {
            throw new Exception("Exception AALogin");
        }
